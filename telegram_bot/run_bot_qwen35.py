#!/usr/bin/env python3
"""
Telegram Bot - DeepSeek-R1-Distill-Qwen-1.5B版本

使用DeepSeek-R1-Distill-Qwen-1.5B模型，经过充分测试
"""
...
class TelegramBot:
    ...
    def __init__(self, token: str, model_path: str, device: str = "cpu"):
        ...
        print("\n" + "=" * 60)
        print("DeepSeek-R1-Distill-Qwen-1.5B Telegram Bot")
        print("=" * 60)
        
        from core.qwen35_bot import DeepSeekContinuousBot
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            "🧠 DeepSeek-R1-Distill-Qwen-1.5B 连续对话Bot\n\n"
            "特性：\n"
            "• 推理树注入\n"
            "• 上下文记忆\n"
            "• 重复检测\n"
...
def main():
    parser = argparse.ArgumentParser(description="DeepSeek-R1-Distill-Qwen-1.5B Telegram Bot")
