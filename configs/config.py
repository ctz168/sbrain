...
基于DeepSeek-R1-Distill-Qwen-1.5B底座模型
...
class HippocampusConfig:
    """海马体记忆系统配置"""
    # 内嗅皮层EC编码
    EC_input_dim: int = 1536  # DeepSeek-R1-Distill-Qwen-1.5B隐藏层维度
...
class BrainConfig:
    """类人脑双系统全闭环AI架构全局配置"""
    # 模型配置
    model_name: str = "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"  # 使用DeepSeek R1 1.5B模型
    model_path: str = "./models/DeepSeek-R1-Distill-Qwen-1.5B"
    hidden_size: int = 1536  # DeepSeek-R1-Distill-Qwen-1.5B的隐藏层维度
