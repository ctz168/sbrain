...
class DeepSeekContinuousBot:
    ...
    def __init__(self, model_path: str, device: str = "cpu"):
        ...
        print("\n" + "=" * 60)
        print("DeepSeek-R1-Distill-Qwen-1.5B 连续对话Bot")
        print("=" * 60)
...
def create_bot(model_path: str, device: str = "cpu") -> DeepSeekContinuousBot:
    """创建Bot"""
    return DeepSeekContinuousBot(model_path=model_path, device=device)
